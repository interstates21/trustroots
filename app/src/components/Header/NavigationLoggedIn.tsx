...
// import { Navbar, NavDropdown, Nav, NavItem:DropMenuItem } from 'react-bootstrap';
...
//           title={t('Support')}
//         >
//           <DropMenuItem href="/faq">{t('Frequently Asked Questions')}</DropMenuItem>
//           <DropMenuItem href="/support">{t('Contact us')}</DropMenuItem>
//         </NavDropdown>
//       </Nav>

//       <Nav className="nav-header-primary">
//         <MenuItem currentPath={currentPath} path="/circles" aria-label={t('Circles')}>
//           <Icon className="visible-xs-block" fixedWidth icon="tribes" size="lg" />
//           <span className="hidden-xs">{t('Circles')}</span>
//         </MenuItem>
//         <MenuItem currentPath={currentPath} path="/search" aria-label={t('Search hosts')}>
//           <Icon className="visible-xs-block" fixedWidth icon="search" size="lg" />
//           <span className="hidden-xs">{t('Search')}</span>
//         </MenuItem>
//         <MenuItem currentPath={currentPath} path="/messages" aria-label={t('Messages')}>
//           <Icon className="visible-xs-block" fixedWidth icon="messages" size="lg" />
//           <span className="hidden-xs">{t('Messages')}</span>
//           <unread-count></unread-count>
//         </MenuItem>
//         <MenuItem currentPath={currentPath} path="/offer/host" className="hidden-xs">
//           {t('Host')}
//         </MenuItem>
//         <MenuItem currentPath={currentPath} path="/offer/meet" className="hidden-xs">
//           {t('Meet')}
//         </MenuItem>
//         <NavDropdown
...
//           }
//         >
//           <li role="presentation" className="dropdown-header" aria-hidden="true">
//             {user.displayName}
//           </li>
//           <DropMenuItem divider />
//           <DropMenuItem href={`/profile/${user.username}`}>{t('My profile')}</DropMenuItem>
//           <DropMenuItem href="/profile/edit">{t('Edit profile')}</DropMenuItem>
//           <DropMenuItem href={`/profile/${user.username}/contacts`}>{t('Contacts')}</DropMenuItem>
//           <DropMenuItem href="/search/members">{t('Find people')}</DropMenuItem>
//           <DropMenuItem divider />
//           <DropMenuItem href="/profile/edit/account">{t('Account')}</DropMenuItem>
//           <DropMenuItem
...
const NavigationLoggedIn: FC<NavigationLoggedInProps> = () => {
